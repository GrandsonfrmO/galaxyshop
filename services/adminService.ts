 ...
 */
export const fetchPWASettings = async () => {
  try {
    const response = await fetch(`${API_BASE}/pwa/settings`);
    if (!response.ok) {
 ...
 */
export const savePWASettingsAPI = async (settings: any) => {
  try {
    const response = await fetch(`${API_BASE}/pwa/settings`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
    ...
    if (!response.ok) {
      throw new Error(`Failed to save PWA settings: ${response.status}`);
    }
 ...
 * Get PWA icons (admin)
 */
export const fetchPWAIcons = async () => {
  try {
    const response = await fetch(`${API_BASE}/pwa/icons`);
    if (!response.ok) {
      throw new Error(`Failed to fetch PWA icons: ${response.status}`);
    }
    return await response.json();
  } catch (error) {
 ...
 */
export const savePWAIconsAPI = async (icons: any) => {
  try {
    const response = await fetch(`${API_BASE}/pwa/icons`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
    ...
    if (!response.ok) {
      throw new Error(`Failed to save PWA icons: ${response.status}`);
    }
